...
<div class="action  divaction">
	...
	<div class="pages">
		<div class="forms">
			 <s:form action="claimVoucher_searchClaimVoucher.action" name="queryForm" theme="simple" method="get">
	       		<label>报销单状态</label>
	  			...
	  			<s:select label="Months"        name="struts"   
	  			       list="#{'':'全部','已付款':'已付款', '已审批':'已审批','已提交':'已提交','已打回':'已打回','新创建':'新创建','待审批':'待审批'}"/>
		       ...
		       <input type="hidden" name="currPageNo"  id="pageNo" value="1"/>
	...
	<s:form action="claimVoucher_searchClaimVoucher.action" name="claimVoucherForm">
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <s:iterator value="pageSupport.itme" id="claimVoucher" begin="0" status="s">
	      <tr>
